...
export const mockEmployees = [
  {
    ...
    aiEvaluation: {
      ...
      growthHistory:
        '2018 年加入机票事业群，近五年持续深耕交易链路架构方向。2019 年 5→6、2022 年 6→7（提前半年）完成晋升，岗位聚焦高并发交易与中台建设，未发生跨事业部转岗。',
      strengths:
...
2019年 5→6`,
  },
  {
    ...
    aiEvaluation: {
      ...
      growthHistory:
        '2020 年校招入职 FU 技术中心，近五年始终在搜索算法组成长。2022 年 5→6 完成晋升，从独立贡献者成长为组内骨干，专注搜索与 NLP 方向，无跨部门调动。',
      strengths:
...
2020年 4→5（校招入职）`,
  },
  {
    ...
    aiEvaluation: {
      ...
      growthHistory:
        '2015 年社招加入机票事业群，近五年由架构与管理双线晋升：2018 年 6→7、2022 年 7→8（破格）。历任架构组与事业群技术管理岗位，主导国际化与商业化攻坚。',
      strengths:
...
2015年 5→6（社招入职定级）`,
  },
  {
    ...
    aiEvaluation: {
      ...
      growthHistory:
        '2019 年加入大住宿产品部，近五年深耕住宿 C 端与增长方向。2019 年 4→5（社招定级）、2022 年 5→6 晋升，岗位由独立负责模块到牵头核心产品线，无跨事业部转岗。',
      strengths:
...
2019年 4→5（社招入职）`,
  },
  {
    ...
    aiEvaluation: {
      ...
      growthHistory:
        '2017 年加入商旅事业部企业服务部，近五年专注大客户方向。2017 年定级 5、2020 年 5→6、2023 年 6→7（因业绩超额），由交付骨干成长为大客户组核心。',
      strengths:
...
2017年 5（社招入职定级）`,
  },
  {
    ...
    aiEvaluation: {
      ...
      growthHistory:
        '2022 年校招入职旅游事业群前端组，近五年完成 3→4→5 连续晋升（2023 年提前晋升 5）。始终在前端方向成长，承担从业务模块到架构与工程化建设职责。',
      strengths:
...
2022年 3→4（校招入职）`,
  },
  {
    ...
    aiEvaluation: {
      ...
      growthHistory:
        '2020 年加入火车票事业群用户增长部，近五年由活动执行到策略负责人。2020 年 4→5（社招）、2022 年 5→6 晋升，持续在用户运营与增长方向，无转岗。',
      strengths:
...
2020年 4→5（社招入职）`,
  },
  {
    ...
    aiEvaluation: {
      ...
      growthHistory:
        '2014 年加入 FU 技术中心，近五年由中间件骨干至部门负责人。2016 年 6→7、2020 年 7→8 晋升，长期深耕基础架构与中间件，未跨事业部调动。',
      strengths:
...
2014年 5→6（社招入职）`,
  },
  {
    ...
    aiEvaluation: {
      ...
      growthHistory:
        '2021 年加入大住宿客户服务部，近五年深耕高星级酒店组。2021 年 3→4（社招）、2023 年 4→5（提前晋升），岗位聚焦一线服务与复杂客诉，无转岗。',
      strengths:
...
2021年 3→4（社招入职）`,
  },
  {
    ...
    aiEvaluation: {
      ...
      growthHistory:
        '2018 年校招入职 FU 数据产品部，近五年由模块产品到数据中台与商业化牵头人。2018 年 4→5、2019 年 5→6、2022 年 6→7 晋升，专注数据 B 端与平台化。',
      strengths:
...
2018年 4→5（校招入职）`,
  },
  {
    ...
    aiEvaluation: {
      ...
      growthHistory:
        '2019 年加入旅游事业群订单系统组，近五年专注后端与交易域。2019 年 4→5（社招）、2022 年 5→6 晋升，承担从核心开发到架构与稳定性负责人，无跨部门转岗。',
      strengths:
...
2019年 4→5（社招入职）`,
  },
  {
    ...
    aiEvaluation: {
      ...
      growthHistory:
        '2016 年加入 FU 基础架构云平台组，近五年深耕云原生与 FinOps。2016 年定级 5、2017 年 5→6、2021 年 6→7 晋升，岗位持续聚焦云平台与多云架构，无转岗。',
      strengths:
